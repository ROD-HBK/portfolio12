...
<div className="portfolioMainDiv">
    ...
    <Projects  num={1} url={project1Image}/> 
<Projects  num={2}  url={project2Image}/>
<Projects   num={3}  url={project3Image}/>
</div>

<div className="threeInOne">
    <Projects   num={4} url={project4Image} />
<Projects num={5} url={project5Image} />
<Projects num={6} url={project6Image} />

</div>

<div className="threeInOne">
<Projects num={7} url={project7Image} />
<Projects num={8}  url={project8Image} />
<Projects  num={9}  url={project9Image} />
</div>
